#pragma message("#include \"tool_contact_controller_parameters.hpp\" is deprecated. Use #include <ur_controllers/tool_contact_controller_parameters.hpp> instead.")
...
namespace tool_contact_controller {
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("tool_contact_controller"), prefix) {
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "action_monitor_rate")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "The rate at which the action should be monitored in Hz.";
          descriptor.read_only = false;
