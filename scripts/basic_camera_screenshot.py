...
"""
Basic Camera Screenshot
=======================

Simple script to take a screenshot using the eval_camera from the edited scene.

Author: Training Validation Team
Date: 2025-09-02
Purpose: Test the edited camera configuration with basic screenshot
"""
...
def test_eval_camera():
    ...
    # Take a screenshot using Isaac Sim's basic viewport capture
    print("📸 Taking screenshot...")
    
    try:
        # Use Isaac Sim's basic viewport capture
        ...
        # Save the image using Isaac Sim's basic save functionality
